...
# Lines 854-922 (0-indexed: 853-921) are the old TICKETS section
# Line 923 (0-indexed 922) onwards is the blank line before SCANNER
start = 853   # 0-indexed, inclusive
end   = 922   # 0-indexed, exclusive  (line 923 is blank before SCANNER)
...
print(f"SUCCESS: replaced lines {start+1}–{end} ({end-start} lines) with {new_section.count(chr(10))} new lines")
